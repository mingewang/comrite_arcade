...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        self.laser_sound2 = arcade.load_sound(":resources:sounds/laser5.wav")
    ...
    def setup(self):
        ...
        self.player_sprite = arcade.Sprite(":resources:images/animated_characters/male_person/malePerson_walk1.png", SPRITE_SCALING_PLAYER)
