""" Sprite Sample Program with installer"""
...
class MyGame(arcade.Window):
    ...
    def __init__(self):
        ...
        self.laser_sound = arcade.load_sound("resources/sounds/laser.wav")
        self.background_music = arcade.load_sound("resources/sounds/background_music.mp3")
